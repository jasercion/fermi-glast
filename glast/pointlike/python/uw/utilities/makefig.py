...
$Header: /glast/ScienceTools/glast/pointlike/python/uw/utilities/Attic/makefig.py,v 1.1.2.1 2015/08/13 18:03:05 jasercio Exp $
...
import pylab  as plt
version='$Revision: 1.1.2.1 $'.split()[1]
