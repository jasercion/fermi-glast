...
$Header: /glast/ScienceTools/glast/pointlike/python/uw/like/Attic/roi_tsmap.py,v 1.1.2.2 2015/08/27 14:31:52 jasercio Exp $
...
from libpointlike import IntVector,DoubleVector
