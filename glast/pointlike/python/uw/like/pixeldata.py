...
Manage data and livetime information for an analysis
    ...
    $Header: /glast/ScienceTools/glast/pointlike/python/uw/like/Attic/pixeldata.py,v 1.1.2.3 2015/08/27 14:31:52 jasercio Exp $
...
Create a new PixelData instance, managing data and livetime.
    ...
    def _Data_setup(self,bins):
        ...
        if not self._binner_set:
            from libpointlike import DoubleVector,IntVector
